...
const file_auth_proto_rawDesc = "" +
	...
	"\rUsersProvider\x126\n" +
	"\aGetUser\x12\x14.auth.GetUserRequest\x1a\x15.auth.GetUserResponseb\x06proto3"
...
var file_auth_proto_depIdxs = []int32{
	0, // 0: auth.UsersProvider.GetUser:input_type -> auth.GetUserRequest
	1, // 1: auth.UsersProvider.GetUser:output_type -> auth.GetUserResponse
