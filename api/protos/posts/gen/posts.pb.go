...
const file_posts_proto_rawDesc = "" +
	...
	"\rGetPostsBatch\x12\x16.posts.GetPostsRequest\x1a\x17.posts.GetPostsResponse\x12D\n" +
	"\vApprovePost\x12\x19.posts.ApprovePostRequest\x1a\x1a.posts.ApprovePostResponseB>Z<github.com/goriiin/kotyari-bots_backend/api/protos/posts/genb\x06proto3"
...
var file_posts_proto_goTypes = []any{
	...
	(*ApprovePostRequest)(nil),  // 4: posts.ApprovePostRequest
	(*ApprovePostResponse)(nil), // 5: posts.ApprovePostResponse
}
var file_posts_proto_depIdxs = []int32{
	...
	4, // 4: posts.PostsService.ApprovePost:input_type -> posts.ApprovePostRequest
	1, // 5: posts.PostsService.GetPost:output_type -> posts.GetPostResponse
	3, // 6: posts.PostsService.GetPostsBatch:output_type -> posts.GetPostsResponse
	5, // 7: posts.PostsService.ApprovePost:output_type -> posts.ApprovePostResponse
