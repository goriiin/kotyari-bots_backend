...
import (
	...
	profiles_adapter "github.com/goriiin/kotyari-bots_backend/internal/adapters/profiles"
...
func (b *BotsApp) Run() error {
	...
	// Инициализация gRPC клиента для сервиса профилей
	conn, err := grpc.Dial(b.config.ProfilesSvcAddr, grpc.WithTransportCredentials(insecure.NewCredentials()))
	if err != nil {
